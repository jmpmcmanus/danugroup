...
if (os.getenv('SERVER_SOFTWARE', '').startswith('Google App Engine') or
    ...
    DATABASES = {
        'default': {
                    ...
                    'INSTANCE': 'danugroup:danugroupsqldb',
                    'NAME': 'danugroupdb',
                    'USER': 'root',
        }
    }
    ...
    # Running in development, using a Google Cloud SQL database.
    #SETTINGS_MODE='prod' ./manage.py syncdb
    DATABASES = {
        'default': {
                    'ENGINE': 'google.appengine.ext.django.backends.rdbms',
                    'INSTANCE': '/cloudsql/danugroup:danugroupsqldb',
                    'NAME': 'danugroupdb',
                    'USER': 'root',
                   }
    }
