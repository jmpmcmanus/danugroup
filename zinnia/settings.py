...
SAVE_PING_EXTERNAL_URLS = False
SAVE_PING_DIRECTORIES = False
PING_DIRECTORIES = getattr(settings, 'ZINNIA_PING_DIRECTORIES', ('http://django-blog-zinnia.com/xmlrpc/',))
...
ENTRY_DETAIL_TEMPLATES = getattr(settings, 'ZINNIA_ENTRY_DETAIL_TEMPLATES', [])
ENTRY_CONTENT_TEMPLATES = getattr(settings, 'ZINNIA_ENTRY_CONTENT_TEMPLATES', [])
...
PREVIEW_SPLITTERS = getattr(settings, 'ZINNIA_PREVIEW_SPLITTERS', ['<!-- more -->', '<!--more-->'])
...
WYSIWYG = getattr(settings, 'ZINNIA_WYSIWYG', WYSIWYG_MARKUP_MAPPING.get(MARKUP_LANGUAGE))

AUTO_CLOSE_PINGBACKS_AFTER = getattr(settings, 'ZINNIA_AUTO_CLOSE_PINGBACKS_AFTER', None)
AUTO_CLOSE_TRACKBACKS_AFTER = getattr(settings, 'ZINNIA_AUTO_CLOSE_TRACKBACKS_AFTER', None)
AUTO_CLOSE_COMMENTS_AFTER = getattr(settings, 'ZINNIA_AUTO_CLOSE_COMMENTS_AFTER', None)
AUTO_MODERATE_COMMENTS = getattr(settings, 'ZINNIA_AUTO_MODERATE_COMMENTS', False)
...
PINGBACK_CONTENT_LENGTH = getattr(settings, 'ZINNIA_PINGBACK_CONTENT_LENGTH', 300)
...
URL_SHORTENER_BACKEND = getattr(settings, 'ZINNIA_URL_SHORTENER_BACKEND', 'zinnia.url_shortener.backends.default')
